...
**
** This header file contains the details for the Sequencer class.
 * The sequencer contains a constructor and destructor to create and
 * eventually delete the dynamically created DNA sequences for suspects
 * and evidence. Methods are established as well as member variables to populate
 * and handle the DNA sequences.
***********************************************/
#ifndef SEQUENCER_H
#define SEQUENCER_H
