...
**
** This header file contains the details for the DNA class, our linked
 * list in this project. There are constructors and destructors to create
 * and delete old dynamically allocated nodes. There are various methods to make
 * the linked list operable.
***********************************************/
#ifndef DNA_H
#define DNA_H
