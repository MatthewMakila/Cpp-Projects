...
**
** This header file includes the public methods for the
 * Ship class and its private member variables. Global constants
 * for the Ship class are stored here as well.
***********************************************/
...
const char WIN_RANK = RANKS[4];
const int RANK_SIZE = 5;
