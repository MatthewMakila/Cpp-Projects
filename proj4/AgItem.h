...
**
** This file is the describes the parent class for the Agricultural items (the animals,
 * vegetables, and trees). Each of these subclasses inherits traits from this parent class.
 * The purely virtual functions make this class abstract.
***********************************************/
