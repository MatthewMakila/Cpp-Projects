...
**
** This header file describes the behavior of the Tree subclass (parent AgItem).
 * Information to declare the Tree's own Tick and harvest functions are included. Each
 * tree has its own age and a vector for its fruit
***********************************************/
