...
**
** This header file describes the behavior of animal subclass (parent AgItem).
 * Information to declare the Animal's own Tick and harvest functions are included
 * Each animal has its own name and a variable for hunger.
***********************************************/
